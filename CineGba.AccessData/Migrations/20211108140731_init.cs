    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "https://i.imgur.com/849x64V.png", "Batman and Robin try to prevent the evil pair of Mr Freeze and Poison Ivy from freezing the town. While doing so, they also try hard to continue their partnership.", "Batman and Robin", "https://www.youtube.com/embed/0-GIJSZ2GAk" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 11, 8, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 9, 0, 0, 0), 1, 1 },
                    { 20, new DateTime(2021, 11, 20, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 9, 0, 0, 0), 6, 3 },
                    { 16, new DateTime(2021, 11, 16, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 10, 0, 0, 0), 9, 3 },
                    { 12, new DateTime(2021, 11, 12, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 11, 0, 0, 0), 12, 3 },
                    { 10, new DateTime(2021, 11, 10, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 15, 0, 0, 0), 11, 3 },
                    { 8, new DateTime(2021, 11, 8, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 13, 0, 0, 0), 8, 3 },
                    { 6, new DateTime(2021, 11, 8, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 19, 0, 0, 0), 6, 3 },
                    { 21, new DateTime(2021, 11, 21, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 11, 0, 0, 0), 2, 2 },
                    { 19, new DateTime(2021, 11, 19, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 16, 0, 0, 0), 7, 2 },
                    { 17, new DateTime(2021, 11, 17, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 17, 0, 0, 0), 8, 2 },
                    { 22, new DateTime(2021, 11, 22, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 13, 0, 0, 0), 2, 3 },
                    { 14, new DateTime(2021, 11, 14, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 22, 0, 0, 0), 10, 2 },
                    { 7, new DateTime(2021, 11, 8, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 13, 0, 0, 0), 7, 2 },
                    { 18, new DateTime(2021, 11, 18, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 19, 0, 0, 0), 8, 1 },
                    { 15, new DateTime(2021, 11, 15, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 17, 0, 0, 0), 9, 1 },
                    { 13, new DateTime(2021, 11, 13, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 18, 0, 0, 0), 10, 1 },
                    { 9, new DateTime(2021, 11, 9, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 13, 0, 0, 0), 11, 1 },
                    { 5, new DateTime(2021, 11, 8, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 22, 0, 0, 0), 5, 1 },
                    { 4, new DateTime(2021, 11, 8, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 19, 0, 0, 0), 4, 1 },
                    { 3, new DateTime(2021, 11, 8, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 16, 0, 0, 0), 3, 1 },
                    { 2, new DateTime(2021, 11, 8, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 13, 0, 0, 0), 2, 1 },
                    { 11, new DateTime(2021, 11, 11, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 14, 0, 0, 0), 12, 2 },
                    { 23, new DateTime(2021, 11, 8, 0, 0, 0, 0, DateTimeKind.Local), new TimeSpan(0, 9, 0, 0, 0), 1, 3 }
                });
